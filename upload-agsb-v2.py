...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "lyb371"         # 用户名
UUID = "ee3cd834-b40d-43a4-998e-0f217777834a"                     # UUID，留空则自动生成
PORT = 47777                   # Vmess端口，留空或0则自动生成
DOMAIN = "yy.longyoytianxia6.pp.ua"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMmMwODFmODcyZDczMWJhMjI4NDZhOWVlMmJhMWVkYjEiLCJ0IjoiYTFjYThjM2ItNDkyZi00NjIwLThiZmMtNDdhNzA0NmNiZWVlIiwicyI6Ik5ERTRNalV3TkRZdE1UaGlNUzAwWlRWakxXRm1NVFl0TVdGa05EUXhNVGN5TW1GbSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
